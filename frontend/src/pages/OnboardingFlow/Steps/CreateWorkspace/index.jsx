...
const DESCRIPTION =
  "Create your first workspace and get started with Outamation AI.";
      ...
      <div className="flex flex-col gap-y-4 w-full max-w-[600px]">
        ...
        <div className="w-full mt-4">
          ...
          <input
            name="name"
            type="text"
            className="bg-black/80 text-white placeholder:text-white/40 text-sm rounded-lg block w-full p-2.5"
