        ...
        <div className="w-full flex flex-col gap-y-2 max-w-[700px]">
          ...
          <div className="flex flex-col gap-y-[25px] text-white/80 text-sm">
            ...
            <p>
              ...
              using one right now with OutamationLLM!
            </p>
            <p>
              When you create a custom fine-tune with OutamationLLM we will train
              a custom base model on your specific data already inside of this
              OutamationLLM instance and give you back a <code>GGUF</code> file
