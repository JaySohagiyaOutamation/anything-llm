    ...
    return (
      <div>
        ...
        <select
          ...
          required={true}
          disabled={true}
          className="bg-black text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
        >
  ...
  return (
    <div>
      ...
      <select
        ...
        className="bg-black bg-opacity-70 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
      >
