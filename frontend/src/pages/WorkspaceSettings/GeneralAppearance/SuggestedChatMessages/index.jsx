        ...
        {suggestedMessages.map((suggestion, index) => (
          <div key={index} className="relative w-full bg-white">
            ...
            <button
              ...
              className={`text-left p-2.5 border rounded-xl w-full text-white border-white/20 bg-black bg-opacity-70 hover:bg-gray-500 ${
        ...
        <div className="flex flex-col gap-y-4 mr-2 mt-8">
          <div className="w-1/2">
            ...
            <input
              ...
              className=" bg-black bg-opacity-70 text-white placeholder:text-white/20 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 w-full"
