  ...
  return (
    <div>
      ...
      <select
        ...
        defaultValue={ workspace?.similarityThreshold ?? 0.5}
        className="bg-black bg-opacity-70 text-white text-sm mt-2 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
