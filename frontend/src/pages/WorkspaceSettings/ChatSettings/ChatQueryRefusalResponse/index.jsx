    ...
    <div>
      <div className="flex flex-col">
        ...
        <p className="text-black text-opacity-60 text-xs font-medium py-1.5">
          ...
          <code className="bg-black bg-opacity-35 p-0.5 rounded-sm">
      ...
      <textarea
        ...
        className="border-none bg-black bg-opacity-70 placeholder:text-white/20 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 mt-2"
