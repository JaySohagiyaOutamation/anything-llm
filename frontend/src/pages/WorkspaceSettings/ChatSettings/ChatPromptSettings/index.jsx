  ...
  return (
    <div>
      ...
      <textarea
        ...
        className="bg-black bg-opacity-70 placeholder:text-white/20 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 mt-2"
