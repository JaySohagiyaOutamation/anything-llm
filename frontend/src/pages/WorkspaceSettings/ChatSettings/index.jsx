      ...
      >
        ...
        {hasChanges && (
          <button
            ...
            className="w-fit transition-all duration-300 border border-slate-200 px-5 py-2.5 rounded-lg text-black bg-slate-200 text-sm items-center flex gap-x-2 focus:ring-gray-800"
          >
