      ...
      <div className="relative bg-white rounded-lg shadow">
        <div className="flex items-start justify-between p-4 border-b rounded-t border-gray-600">
          ...
          <button
            onClick={closeModal}
            type="button"
            className="transition-all duration-300 text-gray-400 hover:bg-gray-200 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center hover:border-slate-100 hover:border-opacity-50 border-transparent border"
