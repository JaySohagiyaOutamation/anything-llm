        ...
        <div className="flex flex-col w-full px-1 md:pl-6 md:pr-[50px] md:py-6 py-16">
          <div className="w-full flex flex-col gap-y-1 pb-6 border-black border-b border-opacity-60">
            <div className="items-center flex gap-x-4">
              <p className="text-lg leading-6 font-bold text-black">Users</p>
            </div>
        ...
        <div className="mt-4">
          ...
          <div className="relative mt-2">
            <input
              ...
              value={limit}
              min={1}
              className="bg-black/70 text-white placeholder:text-white/20 text-sm rounded-lg focus:border-white block w-60 p-2.5"
            />
          </div>
        </div>
      )}
