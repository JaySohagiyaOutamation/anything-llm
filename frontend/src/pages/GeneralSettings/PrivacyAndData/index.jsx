    ...
    <div className="w-screen h-screen overflow-hidden bg-white flex">
      ...
      >
        <div className="flex flex-col w-full px-1 md:pl-6 md:pr-[50px] md:py-6 py-16">
          <div className="w-full flex flex-col gap-y-1 pb-6 border-black border-b border-opacity-40">
        ...
        <div className="flex flex-col gap-y-2 border-b border-zinc-500/50 pb-4">
          ...
          <ul className="flex flex-col list-disc ml-4">
            {LLM_SELECTION_PRIVACY[llmChoice].description.map((desc) => (
              <li className="text-black/90 text-sm">{desc}</li>
            ))}
          </ul>
        </div>
        <div className="flex flex-col gap-y-2 border-b border-zinc-500/50 pb-4">
      ...
      <div className="relative rounded-lg">
        ...
        <div className="flex flex-col items-left space-y-2">
          ...
          <p className="text-black/80 text-xs rounded-lg w-96">
            ...
            so that we can continue to improve Outamation AI for you.{" "}
            <a
              href="mailto:info@outamation.com"
              className="underline text-blue-400"
              target="_blank"
            >
              info@outamation.com
