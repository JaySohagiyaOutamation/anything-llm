        ...
        >
          <form onSubmit={handleSubmit} className="flex w-full">
            <div className="flex flex-col w-full px-1 md:pl-6 md:pr-[50px] md:py-6 py-16">
              ...
              <div className="text-base font-bold text-black mt-6 mb-4">
              ...
              <div className="relative">
                ...
                {searchMenuOpen ? (
                    ...
                    <div className="w-full flex flex-col gap-y-1">
                      <div className="flex items-center sticky top-0 border-b border-[#9CA3AF] mx-4 bg-white">
                        ...
                        <input
                          ...
                          className="-ml-4 my-2 z-20 pl-12 h-[38px] w-full px-4 py-1 text-sm focus:outline-primary-button active:outline-primary-button outline-none text-black placeholder:text-black placeholder:font-medium"
                  ...
                  <button
                    className="w-full max-w-[640px] h-[64px] bg-black bg-opacity-70 text-white placeholder:text-white/70 rounded-lg flex items-center p-[14px] justify-between cursor-pointer border-2 border-transparent hover:border-primary-button transition-all duration-300"
                    type="button"
