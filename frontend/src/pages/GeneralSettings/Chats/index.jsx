                  ...
                  <div className="py-2">
                    {Object.entries(exportOptions).map(([key, data]) => (
                      <button
                        ...
                        className="w-full text-left px-4 py-2 text-black text-sm hover:bg-[#9fa2a6]"
                      >
                        {data.name}
                      </button>
                    ))}
    ...
    <>
      ...
      <div className="flex w-full justify-between items-center mt-6">
        <button
          ...
          className="px-4 py-2 rounded-lg border border-slate-200 text-slate-800 text-sm items-center flex gap-x-2 hover:bg-black hover:text-slate-200 disabled:invisible"
          disabled={offset === 0}
        >
          {" "}
          Previous Page
