    ...
    <div className="w-full fixed md:absolute bg-[#abdhde] bottom-0 left-0 z-10 md:z-0 flex justify-center items-center">
      ...
      >
        <div className="flex items-center rounded-lg md:mb-4">
          <div className="w-[95vw] md:w-[635px] bg-blue-100 shadow-2xl border border-white/50 rounded-2xl flex flex-col px-4 overflow-hidden">
            ...
            <div className="flex items-center w-full border-b-2 border-gray-500/50">
              <textarea
                ...
                value={promptInput}
                className="cursor-text max-h-[50vh] md:max-h-[350px] md:min-h-[40px] mx-2 md:mx-0 py-2 w-full text-[16px] md:text-md text-black bg-transparent placeholder:text-black/80 resize-none active:outline-none focus:outline-none flex-grow"
              ...
              {buttonDisabled ? (
                ...
                <>
                  <button
                    ref={formRef}
                    type="submit"
                    className="inline-flex justify-center rounded-2xl cursor-pointer text-black/70 hover:text-black group ml-4"
