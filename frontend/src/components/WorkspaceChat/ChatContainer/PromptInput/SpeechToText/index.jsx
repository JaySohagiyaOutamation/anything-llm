...
export default function SpeechToText({ sendCommand }) {
  ...
  function startSTTSession() {
    if (!isMicrophoneAvailable) {
      alert(
        "Outamation AI does not have access to microphone. Please enable for this site to use this feature."
      );
      return;
    }
  ...
  return (
    ...
    >
      <Microphone
        weight="fill"
        className={`w-6 h-6 pointer-events-none text-black overflow-hidden rounded-full ${
