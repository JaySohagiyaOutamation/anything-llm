...
export default function DnDFileUploaderWrapper({ children }) {
  ...
  return (
    ...
    >
      <div
        hidden={!dragging}
        className="absolute top-0 w-full h-full bg-[#f8fafe] rounded-2xl border-[4px] border-black/10 z-[9999]"
      >
        <div className="w-full h-full flex justify-center items-center rounded-xl">
          <div className="flex flex-col gap-y-[14px] justify-center items-center">
            <img src={DndIcon} width={69} height={69} />
            <p className="text-black text-[24px] font-semibold">Add anything</p>
