                ...
                <div className="flex gap-x-2 items-center justify-between">
                  {(!user || user?.role !== "default") && (
                    <button
                      ...
                      className="flex flex-grow w-[75%] h-[44px] gap-x-2 py-[5px] px-2.5 mb-2 bg-black rounded-[8px] text-white  justify-center items-center hover:bg-menu-item-selected-gradient transition-all duration-300"
                    >
