    ...
    return (
      <div className="px-8">
        ...
        <div className="relative w-[560px] h-[445px] bg-[#E4ECF6] rounded-2xl mt-5">
          <div className="text-black/80 text-xs grid grid-cols-12 py-2 px-8 sticky top-0 z-10 rounded-t-2xl">
      ...
      <div className="relative w-full max-w-2xl max-h-full">
        <div className="relative bg-white rounded-lg shadow">
          ...
          <div className="w-full p-6 text-black text-md flex flex-col gap-y-2">
            <p>
              When you <b>pin</b> a document in Outamation AI we will inject the
            ...
            <p>
              If you are not getting the answers you desire from Outamation AI by
      ...
      <div className="relative w-full max-w-2xl max-h-full">
        <div className="relative bg-main-gradient rounded-lg shadow">
          ...
          <div className="w-full p-6 text-white text-md flex flex-col gap-y-2">
            <p>
              When you <b>watch</b> a document in Outamation AI we will{" "}
