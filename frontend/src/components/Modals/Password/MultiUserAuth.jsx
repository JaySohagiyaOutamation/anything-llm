  ...
  return (
    ...
    >
      ...
      <div className="flex items-center md:p-12 md:px-0 px-6 mt-12 md:mt-0 space-x-2 border-gray-600 w-full flex-col gap-y-8">
        ...
        <button
          type="button"
          className="text-sm flex gap-x-1 text-primary-button hover:underline -mb-8"
  ...
  return (
    <>
      <form onSubmit={handleLogin}>
        <div className="flex flex-col justify-center items-center relative rounded-2xl md:bg-[#f8fafe] md:shadow-[0_4px_14px_rgba(0,0,0,0.25)] md:px-12 py-12 -mt-4 md:mt-0">
          <div className="flex items-start justify-between pt-11 pb-9 rounded-t">
            <div className="flex items-center flex-col gap-y-4">
              <div className="flex gap-x-1">
                ...
                <p className="text-4xl md:text-2xl font-bold bg-gradient-to-r from-[#75D6FF] via-black to-black bg-clip-text text-transparent">
                  {customAppName || "Outamation AI"}
                </p>
              </div>
              <p className="text-sm text-black/90 text-center">
                {t("login.sign-in.start")} {customAppName || "Outamation AI"}{" "}
                {t("login.sign-in.end")}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center md:p-12 px-10 mt-12 md:mt-0 space-x-2 border-gray-600 w-full flex-col gap-y-8">
            <button
              disabled={loading}
              type="submit"
              className="text-white text-sm font-bold focus:ring-4 focus:outline-none rounded-md border-[1.5px] border-primary-button md:h-[34px] h-[48px] hover:text-white hover:bg-primary-button bg-primary-button focus:z-10 w-full"
            >
              {loading
