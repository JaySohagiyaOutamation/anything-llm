...
const doc = {
  info: {
    version: "1.0.0",
    title: "OutamationLLM Developer API",
    description:
      "API endpoints that enable programmatic reading, writing, and updating of your OutamationLLM instance. UI supplied by Swagger.io.",
  },
