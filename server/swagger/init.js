...
const doc = {
  info: {
    version: "1.0.0",
    title: "Outamation AI Developer API",
    description:
      "API endpoints that enable programmatic reading, writing, and updating of your Outamation AI instance. UI supplied by Swagger.io.",
  },
