...
function apiDocumentEndpoints(app) {
  ...
  app.post(
    ...
    #swagger.description = 'Upload a new file to OutamationLLM to be parsed and prepared for embedding.'
    #swagger.requestBody = {
  ...
  app.post(
    ...
    async (request, response) => {
      /*
    #swagger.tags = ['Documents']
    #swagger.description = 'Upload a valid URL for OutamationLLM to scrape and prepare for embedding.'
    #swagger.requestBody = {
              ...
              documents: [
                {
                  ...
                  "wordCount": 252,
                  "pageContent": "OutamationLLM is the best....",
      ...
      content: {
        "application/json": {
          schema: {
            type: 'object',
            example: {
              "textContent": "This is the raw text that will be saved as a document in OutamationLLM.",
              "metadata": {
  ...
  app.get("/v1/document/:docName", [validApiKey], async (request, response) => {
    /*
    #swagger.tags = ['Documents']
    #swagger.description = 'Get a single document by its unique OutamationLLM document name'
