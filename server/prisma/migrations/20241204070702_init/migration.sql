...
CREATE TABLE "supervisorDocuments" (
    ...
    CONSTRAINT "supervisorDocuments_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "workspaces" (
    ...
    "lastUpdatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "openAiPrompt" TEXT,
    "similarityThreshold" DOUBLE PRECISION DEFAULT 0.5,
    "chatProvider" TEXT,
    "chatModel" TEXT,
...
-- AddForeignKey
ALTER TABLE "supervisorDocuments" ADD CONSTRAINT "supervisorDocuments_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "supervisorDocuments" ADD CONSTRAINT "supervisorDocuments_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "workspaces"("id") ON DELETE CASCADE ON UPDATE CASCADE;
